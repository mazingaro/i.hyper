    ...
    with h5py.File(product_path, "r") as f:
        ...
        if lat_hco is not None and lon_hco is not None:
            ...
            hco_geo = Geolocation(
                ...
                ll_e=corners.get(ATTR_LL_E),
                ll_n=corners.get(ATTR_LL_N),
                lr_e=corners.get(ATTR_LR_E),
                lr_n=corners.get(ATTR_LR_N),
                ul_e=corners.get(ATTR_UL_E),
                ul_n=corners.get(ATTR_UL_N),
                ur_e=corners.get(ATTR_UR_E),
                ur_n=corners.get(ATTR_UR_N),
            )
